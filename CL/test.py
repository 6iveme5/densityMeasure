...
density_df = pd.read_csv(os.path.join(CLDATA_DIR, 'valData_gmm_density.csv'))
...
# 3. 加载标准化器并处理特征
scaler_path = os.path.join(CLDATA_DIR, 'scaler.pkl')
...
model_path = os.path.join(CLDATA_DIR, 'nn_model_dropout.pth')
